# @summary Download and extract SQL Server 2008 Sp3. (10.3.5500.0)
...
class sqlserver::v2008::sp3 (
  String $source = 'https://download.microsoft.com/download/7/C/8/7C8F6A23-5876-4C55-91AD-5488360F8FD6/SQLServer2008SP3-KB2546951-x64-ENU.exe',
