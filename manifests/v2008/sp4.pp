# @summary Download and extract SQL Server 2008 Sp4. (10.4.6000.29)
...
#   SQL Version number the patch applies to
class sqlserver::v2008::sp4 (
  String $source = 'https://download.microsoft.com/download/5/E/7/5E7A89F7-C013-4090-901E-1A0F86B6A94C/ENU/SQLServer2008SP4-KB2979596-x64-ENU.exe',
  String $applies_to_version = '10.0.1600.22'
) {
